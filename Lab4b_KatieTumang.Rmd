...
```{r}
ktt_theme <- theme(axis.text.x = element_text(colour="Blue", size = 12, 
                                               angle = 90, hjust = 0.5, 
                                               vjust = 0.5),
                    axis.text.y = element_text(colour = "Blue", size = 10),
                    text=element_text(size = 10))

ggplot(surveys_complete, aes(x = species_id, y = hindfoot_length, fill = "Blues")) +
    geom_boxplot() +
    ktt_theme
```
...
ggsave("file_name.png", my_plot, width = 15, height = 10)
